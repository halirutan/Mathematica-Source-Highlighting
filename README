...
This is the official Mathematica and Wolfram Language code highlighter for [Mathematica.stackexchange.com](mathematica.stackexchange.com/)
...
the `google-code-prettify/src` folder and the `prettify-mma.css` needs to go into the `styles` folder. All other information
...
The `src` folder contains another file: `mathematica-source-highlighter.user.js` which is a userscript that was used
